...
{ 
  ...
  alpha[k+1, 2, 1]<-(alpha[k, 1, 1]*A[1, 2]+alpha[k, 2, 1]*A[2, 2]+
                     alpha[k, 1, 2]*A[3, 2]+alpha[k, 2, 2]*A[4, 2])*f1x1[k+1]*f0x2[k+1]
  alpha[k+1, 1, 2]<-(alpha[k, 1, 1]*A[1, 3]+alpha[k, 2, 1]*A[2, 3]+
                     alpha[k, 1, 2]*A[3, 3]+alpha[k, 2, 2]*A[4, 3])*f0x1[k+1]*f1x2[k+1]
  alpha[k+1, 2, 2]<-(alpha[k, 1, 1]*A[1, 4]+alpha[k, 2, 1]*A[2, 4]+
                     alpha[k, 1, 2]*A[3, 4]+alpha[k, 2, 2]*A[4, 4])*f1x1[k+1]*f1x2[k+1]
  # rescaling alpha
